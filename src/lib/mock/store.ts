...
function seedPayments(): void {
  ...
  const payments = [
    ...
    // pay-016: month(0) = tháng hiện tại, ngày được clamp về 15 (by design trong month() helper)
    ...
    { id: 'pay-020', caseId: 'case-011', customerId: 'cus-011', amount: 10000000, paymentMethod: 'installment', paymentType: 'refund', paymentDate: month(3), status: 'confirmed', confirmedBy: 'user-007', confirmedAt: month(3), note: 'Hoàn trả phần chênh lệch', createdBy: 'user-007', createdAt: month(3), updatedAt: month(3) },
